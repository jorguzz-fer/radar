  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center gap-6">
      <div>
        ...
        <p className="text-gray-500 text-lg">Inteligência editorial para o setor veterinário</p>
      </div>
      ...
      <p className="text-gray-400 text-sm mt-8">Sprint 0 — Setup concluído. Aguardando dados da coleta.</p>
    </div>
  )
}
