...
export type PersonaId = 'cliente' | 'consultor' | 'especialista' | 'pdv'
    ...
    steps: [
      {
        ...
        description: 'Preencha seus dados e crie sua conta em poucos minutos.',
      },
      {
        title: 'Escolha seus serviços',
        description: 'Explore o catálogo e ative os serviços que combinam com você.',
      },
      {
        title: 'Aproveite as vantagens',
        description: 'Comece a usufruir dos benefícios e do programa de fidelidade.',
      },
    ],
    audience: [
    ...
    steps: [
      {
        ...
        description: 'Preencha seus dados e aceite o termo de adesão de Consultor.',
      },
      {
      ...
      },
      {
        ...
        description: 'Cadastre clientes pelo seu link e acompanhe suas comissões.',
      },
    ],
    audience: [
    ...
    steps: [
      {
        ...
        description: 'Preencha o cadastro e passe pela qualificação como Especialista.',
      },
      {
        title: 'Monte sua rede',
        description: 'Cadastre consultores e organize sua estrutura por região ou foco.',
      },
      {
        title: 'Gerencie e escale',
        description: 'Use o painel para acompanhar, treinar e expandir a operação.',
      },
    ],
    audience: [
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        description: 'Treine o time do balcão com nosso material e ative o painel.',
      },
      {
        title: 'Atenda e fature',
        description: 'Ofereça serviços WOW+ aos seus clientes e receba comissões.',
      },
    ],
    audience: [
