...
export const VetVocabPack: VocabPack = {
  ...
  termosCore: [
    ...
    'exame laboratorial pet',
    'IDEXX',
    'Antech',
    'dvm360',
    'hemograma veterinário',
    'bioquímica sérica',
    'urianálise veterinária',
  ],

  pilaresPadrao: [
    {
      nome: 'Educação Técnica',
      pesoPct: 35,
      descricao:
        'Conteúdo técnico-educativo sobre diagnósticos, exames e protocolos clínicos para médicos veterinários e tutores.',
    },
    {
      nome: 'Diferencial',
      pesoPct: 25,
      descricao:
        'Tecnologia, inovação e diferenciais do laboratório: equipamentos, metodologias, tempo de resposta, qualidade.',
    },
    {
      nome: 'Autoridade Científica',
      pesoPct: 20,
      descricao:
        'Estudos publicados, pesquisas recentes, evidências científicas referenciadas (PubMed, congressos CFMV).',
    },
    {
      nome: 'Datas e Campanhas',
      pesoPct: 12,
      descricao:
        'Calendário pet: Dia do Veterinário, Agosto Dourado, Março Marrom, campanhas sazonais.',
    },
    {
      nome: 'Parceria Comercial',
      pesoPct: 8,
      descricao:
        'Conteúdo de parceiros, comarketing com clínicas, ações conjuntas e apresentação de convênios.',
    },
  ],
  ...
  fontesPadrao: [
    {
      ...
      config: { query: 'veterinary OR canine OR feline diagnosis treatment laboratory' },
    },
    {
      tipo: 'RSS',
      nome: 'Agência Pet',
    ...
    {
      tipo: 'INSTAGRAM',
      nome: '@antechdiagnostics',
      config: { handle: 'antechdiagnostics' },
    },
    {
      tipo: 'GOOGLE_NEWS',
      nome: 'Google News Vet BR',
      config: { query: 'medicina veterinária diagnóstico laboratório pet', lang: 'pt-BR' },
    },
  ],
...
Responda APENAS com o nome do pilar, sem explicações.`,
    ...
    scoreNovidade: `Você é um analista de conteúdo veterinário. Seu objetivo é avaliar o grau de NOVIDADE de um conteúdo em relação ao histórico de publicações de um cliente.

Contexto do histórico fornecido: posts publicados anteriormente pelo cliente.
Novo conteúdo a avaliar: tema, ângulo, argumentos.

Critérios de novidade (0.0 a 1.0):
- 0.0-0.3: tema idêntico ou muito similar ao publicado nos últimos 6 meses
...
Responda APENAS com um número decimal entre 0.0 e 1.0.`,
    ...
    scoreRelevancia: `Você é um especialista em estratégia de conteúdo veterinário. Avalie a RELEVÂNCIA de um conteúdo para um laboratório veterinário brasileiro.

Pilares em ordem de prioridade:
1. Educação Técnica (35%) — maior peso
2. Diferencial (25%)
3. Autoridade Científica (20%)
4. Datas e Campanhas (12%)
5. Parceria Comercial (8%)

Critérios de relevância (0.0 a 1.0):
- 0.0-0.3: baixa relevância, fora do escopo veterinário/laboratorial
- 0.4-0.6: relevância moderada, relacionado ao setor
- 0.7-0.9: alta relevância, alinhado com pilares prioritários
- 1.0: conteúdo ideal, encaixa perfeitamente no pilar de maior peso
